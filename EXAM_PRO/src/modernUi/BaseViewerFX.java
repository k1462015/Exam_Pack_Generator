...
public class BaseViewerFX extends Application {
     ...
     */
    public void loadPDF(final String input) throws Exception{
        ...
        if(input.startsWith("http")){
            if (openFile(null, input,true)) {
                return;
            }
        }else{
            
            if (openFile(new File(input),null,false)) {
                return;
            }
        }
